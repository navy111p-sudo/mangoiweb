...
>
> ✅ **확인 방법·날짜 (2026-09-01, 사장님 실측)** — 옮긴 뒤 **두 도메인에서 각각 연습방 `demo-1` 에 들어가
> 「서로 보이는 것」을 눈으로 확인**했습니다. 이것이 «같은 워커인가» 의 유일한 최종 확인이며,
> 8/27 에 «했다» 고 적혔지만 실제로는 빠져 있던 단계입니다.
> ⚠️ 이 확인에는 **D1 뒷받침 기록이 없습니다**(`demo-1` 은 예약방이 아니라 그 세션에서 출석 join 이
> 불리지 않았습니다). 근거는 사람이 본 것뿐이고 그것으로 충분합니다 — 갈려 있으면 서로 보일 수가 없습니다.
> 다음에 확인할 때는 **예약방으로 하면 D1 에도 남습니다.**
>
