...
(function () {
  ...
  var SKIP_SEL = [
    ...
    // 🎬 (2026-08-27) 녹화 관리 복합 필터 칩 — 위 rm-act 와 같은 이유로 «색이 상태 정보» 다.
    //   채운 색 = 켜짐 / 흰 바탕 = 꺼짐. 밝게 눌리면 켜진 칩과 꺼진 칩이 똑같아져
    //   «무슨 조건이 걸려 있는지» 를 화면에서 읽을 수 없다.
    //   글자 대비는 admin-inline-c.css 맨 끝 button.rec-fchip 블록이 함께 정한다.
    '.rec-fchip', '.rec-fchip *',
