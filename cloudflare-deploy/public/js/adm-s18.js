...
(function(){
  ...
  // ph166 (2026-07-23) — 덱 정의를 /js/adm-guide-decks.js 로 옮겼다(단일 출처).
  //   여기와 adm-welcome.js 가 같은 사실을 각자 적어두는 바람에 실제로 어긋났었다.
  //   ⚠️ 덱을 바꾸려면 adm-guide-decks.js 를 고칠 것. 여기에 다시 적지 말 것.
  //   아래 폴백은 그 파일이 어떤 이유로 안 실려도 뷰어가 죽지 않게 하려는 최소 안전장치다.
  var DECKS = window.MANGOI_GUIDE_DECKS || {
