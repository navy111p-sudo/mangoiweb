...
(function () {
  ...
  var SLIDES = [
    ...
    { icon: '🧭',
      ko: { t: '길을 잃으면?', d: '왼쪽 메뉴를 열거나, 화면의 [AI에게 물어보기]에 말로 물어보세요. "숙제 어디서 해?"라고 치면 바로 데려다줘요.' },
      en: { t: 'Lost?', d: 'Open the left menu, or just ask [Ask AI]. Type "Where is my homework?" and it takes you right there.' } }
  ];
