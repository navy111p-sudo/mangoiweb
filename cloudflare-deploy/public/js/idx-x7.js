...
(function(){
  ...
  var DATA=[
   ...
   {c:'레벨테스트',ce:'Level Test',
    ...
    a:'네, 가능합니다. 화면 오른쪽 아래의 [카카오 상담]으로 재신청을 요청해 주시면 일정을 다시 잡아드립니다.\n레벨테스트는 알맞은 과정을 고르기 위한 가이드라인일 뿐이니, 성적이 낮게 나와도 실망하지 않으셔도 됩니다.',
   ...
   {c:'수강문의',ce:'Enrollment',
    ...
    a:'평일 월~금 주 5일, 오전 10시부터 밤 11시까지 수업이 진행됩니다. (주말 수업은 준비 중입니다.)\n화상영어 수업시간은 보통 20분이며, 개인 수업은 20분/40분, 단체 수업도 20분 단위로 진행됩니다.',
    ae:'Classes run Monday to Friday, 10 AM to 11 PM. (Weekend classes are coming soon.)\nA typical class is 20 minutes; private lessons are 20 or 40 minutes, and group lessons also run in 20-minute units.'},
   {c:'수업진행',ce:'Classes',
    q:'화상 수업 시 강사님이 입장하지 않았어요.',
    qe:'My teacher did not show up for class.',
    a:'강사님이 수업을 조금 늦게 시작하거나, 현지 사정(태풍·정전, 병결 등)으로 수업 연결이 되지 않는 경우가 간혹 있습니다.\n화면 오른쪽 아래의 [카카오 상담]으로 알려주시면 센터에 확인하여 보강 수업을 등록해 드리고, 사유에 대한 상담 전화를 드립니다.',
   ...
   {c:'스케줄',ce:'Schedule',
    ...
    a:'네, 화면 오른쪽 아래의 [카카오 상담]을 통해 변경 신청이 가능합니다. 당일 수업 1일 전까지, 월 1회 변경하실 수 있습니다. (단, 강사의 불성실로 인한 교체는 제한 횟수에 포함되지 않습니다.)',
   ...
   {c:'AI·학습',ce:'AI Learning',
    ...
    a:'망고아이는 원어민 선생님의 수업과 A.I 학습관리가 함께 갑니다. 매 수업이 끝나면 A.I가 평가서와 맞춤 복습 퀴즈를 자동 생성하고, [AI 음성코치]에서 A.I 발음 교정 연습을 할 수 있습니다.\n홈 화면의 [AI에게 물어보기]에 궁금한 것을 입력하면 원하는 메뉴로 바로 안내해 드립니다.',
    ae:'At Mangoi, native teachers teach and A.I manages your learning. After every class, A.I generates an evaluation report and a personalized review quiz, and you can practice pronunciation with A.I in [AI Voice Coach].\nType anything into [Ask AI] on the home screen to jump straight to the right menu.'},
   {c:'AI·학습',ce:'AI Learning',
   ...
   {c:'AI학습',ce:'AI Learning',
    q:'예습·복습은 어떻게 하나요? 게임도 있나요?',
    qe:'How do preview and review work? Are there games?',
    a:'수업 전에는 AI 워밍업으로 예습하고, 수업 후에는 AI 복습퀴즈·단어장·발음코치로 복습합니다. 모두 자동 채점되어 [마이페이지]에 쌓입니다.\n3D 영어 배틀 등 게임형 학습 콘텐츠도 수강생에게 무료로 열려 있어, 놀듯이 공부하면서 포인트도 함께 모을 수 있습니다.',
    ae:'Before class you warm up with an AI preview; after class you review with AI quizzes, a vocabulary trainer and a pronunciation coach. Everything is graded automatically and saved in [My Page].\nGame-based content such as the 3D English Battle is also free for enrolled students — learn like you play, and earn points while you do.'},
   {c:'포인트',ce:'Points',
    q:'포인트는 어떻게 모으고 어디에 쓰나요?',
    qe:'How do I earn and spend points?',
    a:'출석, 복습 퀴즈, 학습 게임 등 학습 활동을 통해 포인트가 적립됩니다. 모은 포인트는 홈 화면의 [포인트상점]에서 기프티콘 등 다양한 선물로 교환하실 수 있으며, 스마트폰에서 바로 받아 쓰실 수 있습니다.',
    ae:'You earn points through learning activities such as attendance, review quizzes and learning games. Spend them in the [Point Shop] on the home screen for gift vouchers and other rewards, delivered straight to your phone.'},
   {c:'강사',ce:'Teachers',
   ...
   {c:'강사',ce:'Teachers',
    ...
    a:'[마이페이지]의 요청사항에 남겨주시면 강사님이 확인합니다.\n영작이 어려우시면 [카카오 상담]에 한글로 남겨주세요. 센터로 전달해 드리겠습니다.',
  ...
  var L={
    ko:{ title:'❓ 자주 묻는 질문', sub:'망고아이 화상영어 FAQ — 궁금한 점을 빠르게 확인하세요',
         ...
         foot1:'💬 <b>카카오상담</b> — 화면 오른쪽 아래 상담 버튼', foot2:'상담 운영 10:00~23:00 (주말·공휴일 휴무)', foot3:'수업 10:00~23:00',
    ...
    en:{ title:'❓ FAQ', sub:'Mangoi Video English FAQ — find answers fast',
         ...
         foot1:'💬 <b>KakaoTalk chat</b> — button at bottom right', foot2:'Support 10:00–23:00 (closed weekends/holidays)', foot3:'Classes 10:00–23:00',
