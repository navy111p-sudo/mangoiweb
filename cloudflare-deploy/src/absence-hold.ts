...
function studentMessage(name: string): string {
  /* 💬 (2026-09-25 사장님 「더 완곡하게, 공감 가게」) 탓하는 말·통보하는 말을 빼고 «안부 + 선택지» 로.
     ⚠️ 학부모·학생 번호에 «같은 글» 이 가므로 받는 사람을 «학부모님» 으로 못 박지 않는다. */
  return `[망고아이] 안녕하세요, 망고아이입니다.\n`
    + `최근 두 번의 수업에서 ${name} 학생을 만나지 못해 담당 선생님이 안부를 궁금해하고 있어요. 혹시 바쁜 일이나 사정이 있으셨을까요?\n`
    + `잠시 쉬어 가셔도, 시간을 바꾸셔도 괜찮습니다. 편하실 때 알려 주시면 맞춰 드릴게요.\n`
    + `연락 주시기 전까지는 다음 수업을 잠시 멈춰 두겠습니다.\n`
