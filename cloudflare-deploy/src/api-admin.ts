...
▶ 확인·입장: ${ticketUrl}`; } catch {}
    ...
    if (method === 'POST' && path === '/api/consult-bot') {
      ...
      const KNOWLEDGE_ARR = [
        ...
        '- 대상: 어린이·청소년·성인 모두.',
        '- 상담(운영) 시간: 오전 10시~오후 11시(10:00~23:00, 주말·공휴일 휴무). 수업 시간: 평일 월~금 오전 10시~오후 11시(10:00~23:00). 주말 수업은 준비 중.',
        ...
        '- AI 예습·복습: 수업 전 워밍업(예습)과 수업 후 AI 복습퀴즈·단어장·발음코치를 재미있게 진행. 3D 영어 배틀 등 게임형 학습 콘텐츠도 무료 제공(수강생).',
        '- 포인트: 출석·복습·게임 등 학습으로 적립 → [포인트상점]에서 기프티콘·선물로 교환. 모바일(스마트폰)에서 바로 사용 가능.',
      ...
      const FAQ: Array<{ kw: string[]; a: string }> = [
        ...
        { kw: ['시간', '몇 시', '몇시', '요일', '운영', '언제', '오전', '주말'], a: '수업은 평일 월~금, 오전 10시부터 오후 11시까지 진행돼요 (주말 수업은 준비 중이에요). 상담 운영시간도 오전 10시~오후 11시(주말·공휴일 휴무)이고, 카카오 채널 @망고아이로 문의하시면 가장 빠르게 답변드려요.' },
        ...
        { kw: ['녹화', '영상', '다시보기', '다시 보기', '복습', '예습', '퀴즈', '평가서'], a: '수업 전에는 AI 워밍업으로 예습하고, 수업 후에는 AI 복습퀴즈·단어장·발음코치로 재미있게 복습할 수 있어요. 수업 녹화영상과 AI 평가서도 로그인 후 [마이페이지]에서 언제든 확인하실 수 있어요.' },
        { kw: ['게임', '3D', '재미', '재밌', '흥미', '지루'], a: '망고아이는 AI로 예습·복습을 재미있게 할 수 있어요 — 단어 퀴즈, 발음 코치, 그리고 3D 영어 배틀 같은 게임형 콘텐츠까지 수강생에게 무료로 열려 있어요. 놀듯이 하면서 포인트도 함께 쌓입니다!' },
        { kw: ['포인트', '상점', '적립', '기프티콘', '선물', '상품'], a: '포인트는 출석·복습·게임 등 학습 활동으로 쌓이고, [포인트상점]에서 기프티콘 같은 선물로 교환할 수 있어요. 스마트폰에서 바로 받아 쓰실 수 있습니다.' },
