...
const CAT_RULES: Array<[RegExp, string]> = [
  ...
  [/AWS|아마존웹|클라우드|Cloudflare|호스팅|소프트웨어|Figma|Adobe|어도비|Microsoft|마이크로소프트|GitHub|전산|컴퓨터|노트북|전자|네이버|NAVER|구글|GOOGLE|ANTHROPIC|CLAUDE|OPENAI|CHATGPT|MS\s*365/i, '장비'],
  /* 📞 통신 — 통신사 회선요금만 남긴다 */
