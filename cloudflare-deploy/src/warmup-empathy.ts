...
const NEG_KO: readonly string[] = [
  ...
  '무서워', '무섭', '걱정', '아파', '아팠', '아프다', '아프고', '아픈',
  /* 🪤 '아프'·'화나' 를 «그대로» 두면 «아프리카»·«영화나 볼까» 가 걸립니다(함정 대조 실측).
     머리말이 「뜻이 갈리는 낱말은 뺐다」고 적어 놓고 이 둘이 남아 있었습니다 — 어미까지 붙여 좁혔습니다.
     ⚠️ 그래서 「화나」 한 글자로 끝나는 드문 표기는 못 잡습니다. 그건 프롬프트 규칙이 받습니다. */
  '화났', '화나요', '화나서', '화가 나',
];
