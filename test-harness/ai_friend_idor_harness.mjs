...
// (2026-07-22) NOCASE 로그인 도입으로 토큰은 입력값(uid)이 아니라 DB 원표기(stu.user_id)로 서명 — 둘 다 허용
ok(/token:\s*await\s+signUidToken\((uid|stu\.user_id)/.test(loginBlk), '/api/student/login — 성공 시 서명 토큰 발급');
