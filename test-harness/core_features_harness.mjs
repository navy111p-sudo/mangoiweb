...
// 🔁 리팩토링 내성: api-mango.ts 가 도메인별 모듈(api-lessons/games/admin/...)로 분리됐으므로
//    단일 파일 대신 src/*.ts 전체를 합쳐서 검사한다 → 코드가 어느 모듈에 있든 패턴을 찾음(동작 회귀 가드 본래 의도).
const ALL_SRC = (() => {
  try {
    return readdirSync(resolve(__dir, '../cloudflare-deploy/src/'))
