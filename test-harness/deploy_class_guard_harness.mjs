...
//     으로 좁혀졌고, 2026-09-16 「스케줄이 바뀌어서」로 «화·목 12:00~16:00» 이 되었다.
//     ⚠️ 이 파일의 «창 안» 본보기는 화요일 15:00 KST 라 두 창 모두에서 유효하다(확인함).
//     요일을 좁힌 대가로 **월·수·금이 통째로 창 밖**이고(30일 실접속 328건), 2026-09-16 에
//     시각까지 좁혀 **화·목 17시 이후 300건**도 창 밖이 되었다.
//     ⚠️ 옛 주석은 그 시각이 «실측과 맞는다» 고 했지만 지금은 아니다 — 새 창은 실측 피크
//        (21시)를 안 막는다. 사장님이 테스트 수업 시각을 옮기셨기 때문이고, 그 실측은
//        «옮기기 전» 을 잰 것이다(class-window.mjs 머리말).
