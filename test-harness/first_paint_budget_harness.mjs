...
//   📌 2026-08-23  index.html 1550 → 1159KB (**내렸다**)
//     위 2026-08-21 항목이 「진짜 할 일」로 남겨 둔 그것을 했다 —
//     js/idx-main.js(851KB) 를 «홈»(451KB) 과 «수업»(js/idx-main-vc.js 402KB, defer) 으로 갈랐다.
//     blocking 1557 → 1159KB. 기준선을 «올린» 것이 아니라 «내린» 첫 사례다.
//     ⚠️ 그래서 여유는 여전히 12KB 뿐이다. 「400KB 벌었으니 막 써도 된다」가 아니다.
//     ⚠️ 옮긴 것은 «바이트가 사라진 것» 이 아니다 — defer 는 첫 그림을 막지 않을 뿐,
//        받기는 그대로 받는다. 데이터 자체를 아끼려면 «수업에 들어갈 때 받기» 가 필요하고
//        그건 입장 경로를 전부 손봐야 하는 별건이다.
